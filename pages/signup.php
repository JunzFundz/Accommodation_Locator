...
<body>
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span id="logo-text" class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Acommodation Locator</span>
            </a>
    ...
    <form id="form-input" class="max-w-md mx-auto">
...
<style>
    ...
    .swal2-confirm.custom-confirm-btn:hover {
        background-color: rgb(212, 219, 243) !important;
    }
</style>
