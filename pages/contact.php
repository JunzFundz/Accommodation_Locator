...
<body>
    ...
    <div class="bg-white new-grid">
        <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
            <figure class="max-w-screen-md mx-auto">
                <svg class="h-14 mx-auto mb-3 text-gray-400 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <blockquote>
                    <p class="text-2xl font-medium text-gray-900">If you have any questions or concerns about our Terms and Conditions and Privacy Policy, please
                        contact us at</p>
                </blockquote>
                <figcaption class="flex items-center justify-center mt-6 space-x-3">
                    <img class="w-6 h-6 rounded-full" src="logo.png" alt="profile picture">
                    <div class="flex items-center divide-x-2 divide-gray-500">
                        <div class="pr-5 font-medium text-gray-900">aclsbaisteam@gmail.com </div>
                        <div class="pl-3 text-sm font-light text-gray-500 "> Lower Dike Juan Luna Street., Bais City, Negros Oriental 6206</div>
                    </div>
                </figcaption>
            </figure>
        </div>
